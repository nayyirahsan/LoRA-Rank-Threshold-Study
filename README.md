...
> Status: **results in.** LR calibration (27 runs) and a scoped main grid (55 runs) ran on free Kaggle
> 2×T4 sessions. The SVD-oracle sweep (H2) is being rerun after a device bug
> ([log #17](docs/engineering_log.md)). Cut from this pass for budget: facts N=16k, extra facts seeds,
> the rsLoRA/QLoRA ablations, and the 1.7B check.
